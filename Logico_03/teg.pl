...
ocupaContinente(Jugador, Continente) :-
  jugador(Jugador),                 %  }--> estas dos líneas podrían reemplazarse por estaEnContinente/2.
...
noOcupaPaisDe(Continente, Pais, Jugador) :-  % este predicado podría usarse en cubaLibre para evitar repetir.
  paisContinente(Continente, Pais),
